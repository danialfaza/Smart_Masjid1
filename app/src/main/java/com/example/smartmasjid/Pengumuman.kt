...
class Pengumuman : AppCompatActivity() {
    ...
    fun getdariserver(){
        ...
        AndroidNetworking.get("http://192.168.1.5/belajar_api/contoh_pengumuman_json.php")
    ...
    {
        AndroidNetworking.post("http://192.168.1.5/belajar_api/proses_pengumuman.php")
